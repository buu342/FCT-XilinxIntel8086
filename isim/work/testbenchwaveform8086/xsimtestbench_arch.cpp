...
#include "C:/Xilinx92i/vhdl/hdp/nt/ieee/vital_timing/vital_timing.h"
#include "C:/Xilinx92i/vhdl/hdp/nt/ieee/numeric_std/numeric_std.h"
#include "C:/Xilinx92i/vhdl/hdp/nt/ieee/vital_primitives/vital_primitives.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_testbenchwaveform8086_testbench_arch(const char*);
        topvh = createWork_testbenchwaveform8086_testbench_arch("TestBenchWaveForm8086");
